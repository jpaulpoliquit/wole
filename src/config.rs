...
fn default_output_mode() -> String { "normal".to_string() }
fn default_true() -> bool { true }
fn default_false() -> bool { false }
fn default_refresh_rate() -> u64 { 100 }
fn default_max_no_confirm() -> u64 { 10 }
fn default_max_size_no_confirm() -> u64 { 100 } // 100 MB
fn default_threads() -> u32 { 0 } // 0 = auto-detect
fn default_batch_size() -> usize { 1000 }
fn default_max_history() -> u64 { 10000 }
fn default_history_age_days() -> u64 { 90 }

fn default_project_age() -> u64 { 14 }
fn default_min_age() -> u64 { 30 }
fn default_min_size_mb() -> u64 { 100 }
fn default_memmap_threshold() -> u64 { 10 * 1024 * 1024 } // 10MB
fn default_duplicate_buffer_size() -> usize { 8 * 1024 * 1024 } // 8MB
...
fn matches_pattern(path_lower: &str, pattern: &str) -> bool {
    ...
    if !pattern_lower.contains('*') {
        ...
        if let Some(pos) = path_lower.find(pattern_lower) {
            ...
            let start_ok = pos == 0 || path_lower.as_bytes()[pos - 1] == b'/' || path_lower.as_bytes()[pos - 1] == b'\\';
